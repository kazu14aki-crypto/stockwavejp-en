      ...
      <div style={{ background:'var(--bg2)', border:'1px solid var(--border)',
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))', gap:'10px' }}>
          {[
            ...
            { icon:'🗺️', title:'テーマ×期間Heatmap', desc:'67テーマのReturnを1週〜1年の複数期間で同時比較できる' },
            { icon:'📊', title:'三指標同時表示', desc:'Return・Volume・Trade Valueを67テーマ分まとめてランキング表示' },
            { icon:'⚙️', title:'Custom Theme', desc:'自分だけのテーマを作成して独自の銘柄群を追跡できる' },
            { icon:'📈', title:'マクロ連動表示', desc:'日経Avg・ドル円・VIX等のマクロ指標とテーマ動向を同時確認' },
...
StockWaveJPは、半導体・AI・防衛・インバウンドなど67の投資テーマについて、Return・Volume・Trade Valueを自動集計し、「資金の流れ」を視覚的に把握できるダッシュボードとして開発しました。
...
投資助言や個別銘柄の推奨ではなく、「今市場は何を注目しているか」を客観的なデータで提供することを第一の目的としています。`,
        },
        {
          ...
          title: '作成の背景・理由',
          color: '#aa77ff',
          content: `株式市場では、個別銘柄の分析だけでなく「どのテーマやセクターに資金が流れているか」という大局観が投資判断に非常に重要です。しかし、テーマ別のReturn・Volume・Trade Valueを一元管理できる無料ツールは国内に限られていました。
      ...
      <div style={{ background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:'12px', padding:'22px 26px', marginBottom:'16px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'120px 1fr', gap:'12px 24px', fontSize:'13px', marginBottom:'14px' }}>
          {[
            ...
            ['Data Source', '外部データプロバイダー（Infoway）'],
            ['Update Frequency', 'Several times daily (auto)'],
          ].map(([label, value], i) => (
        ...
        <div style={{ display:'flex', alignItems:'flex-start', gap:'20px', flexWrap:'wrap' }}>
          ...
          <div style={{ flex:1, minWidth:'200px' }}>
            ...
            <div style={{ fontSize:'13px', color:'var(--text2)', lineHeight:2 }}>
              ...
              分析視点を大切にしています。Return・Volume・Trade Value・モメンタムの4指標を組み合わせた
