export default function Disclaimer() {
  const sections = [
    {
      title: '第1条 情報の目的',
      body: `StockWaveJP（以下「当サイト」）は、日本株式市場におけるテーマ別Price Change %・Volume・Trading Value等の統計データおよびコラム記事を提供する情報サービスです。
...
当サイトは金融商品取引法（昭和23年法律第25号）に基づく投資助言業者ではなく、いかなる投資助言も行いません。`,
    },
    {
      ...
      body: `当サイトで表示されるPrice Change %・Volume・Trading Value等の集計数値は、構成銘柄の市場データをもとに当サイトが独自のロジックで算出したものです。
...
これらの第三者サービスに起因する損害について、当サイト運営者は責任を負いません。`,
    ...
    {
      title: '第6条 著作権・知的財産権',
      body: `当サイトに掲載されているColumn記事・テキスト・デザイン・ロゴ・ソースコードその他のコンテンツに関する著作権・知的財産権は、当サイト運営者または正当な権利者に帰属します。
...
当サイトが表示する株価・企業名・証券コード・商標等は、各証券取引所・企業の財産であり、当サイトはこれらの権利を主張するものではありません。`,
    },
    {
      ...
      body: `当サイトは、法令の改正、サービス内容の変更その他の事情により、予告なく本Disclaimerを変更することがあります。変更後のDisclaimerは、当サイトに掲載した時点で効力を生じます。重要な変更については、当サイト上でお知らせします。`,
    },
    {
      title: '第8条 準拠法・管轄裁判所',
