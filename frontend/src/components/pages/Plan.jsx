...
export default function Plan({ onNavigate }) {
  ...
  const PLANS = [
    {
      ...
      features: [
        ...
        'Market Ranking',
        '銘柄検索',
        'Weekly Report（最新1週のみ）',
        'コラム記事（全本）',
        'Custom Theme（ウォッチリスト）',
      ],
    },
    {
      key: 'standard',
      ...
      features: [
        'Freeプランの全機能',
        'Theme Detail・Market Ranking（全期間）',
        'Custom Theme 5テーマ・20銘柄/テーマ',
        'Weekly Report（全アーカイブ）',
        'Market Rankingページ',
      ],
    },
    {
  ...
  const FEATURES = [
    ...
    ['銘柄検索',                                  '✅','✅','✅'],
    ['Column記事（全本）',                  '✅','✅','✅'],
    ['Custom Theme 1テーマ・10銘柄',            '✅','❌','❌'],
    ['Custom Theme 5テーマ・20銘柄/テーマ',    '❌','✅','❌'],
    ['Custom Theme 10テーマ・50銘柄/テーマ',   '❌','❌','✅'],
    ['Weekly Report（1ヶ月以上前のみ）',           '✅','✅','✅'],
    ['Weekly Report（全アーカイブ）',              '❌','✅','✅'],
    ['Market Rankingページ',                          '❌','✅','✅'],
    ['機関投資家大量保有情報',                    '❌','❌','✅'],
    ['優先サポート',                              '❌','❌','✅'],
    ...
    <div style={{ padding:'16px 16px 60px', maxWidth:'860px', margin:'0 auto' }}>
      ...
      <div style={{ background:'rgba(255,200,50,0.08)', border:'1px solid rgba(255,200,50,0.3)',
        ...
        <div style={{ fontSize:'12px', color:'var(--text2)', lineHeight:1.8 }}>
          ...
          Settingsページの「現在のプラン」には加入したプランが表示され、解約ボタンから解約できます。<br/>
