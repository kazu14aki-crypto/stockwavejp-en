...
const MODES = ['🏆 Top5 + Bottom5', '✅ Manual Select', '📊 All Themes']
...
function Loading() {
  return (
    <div style={{ textAlign: 'center', padding: '60px', color: 'var(--text3)' }}>
      ...
      <div style={{ marginTop: '12px', fontSize: '12px' }}>Loading daily data. The first request may take longer.</div>
    </div>
  )
}
  ...
  return (
    <div style={{ padding: '28px 32px 48px' }}>
      ...
      <p style={{ fontSize: '12px', color: 'var(--text3)', marginBottom: '20px' }}>
        Cumulative theme returns calculated from daily closing prices
      </p>
