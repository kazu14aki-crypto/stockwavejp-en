...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      '各グラフはクリックで拡大表示できます。',
      '「＋」ボタンで銘柄をAdd to Custom Themeできます。',
    ]
  },
  {
    icon: '📋',
  ...
  },
  {
    ...
    items: [
      ...
      'GoogleLoginするとデバイスをまたいでテーマが同期されます。未Loginの場合はブラウザのLocalStorageに保存されます。',
  ...
  },
  {
    ...
    items: [
      'Color Theme: ダーク（デフォルト）・ライト（ホワイト）から選択できます。',
...
const QA = [
  {
    q: 'データはリアルタイムですか？',
    a: 'リアルタイムではありません。GitHub Actionsにより1日数回（平日7:00/9:00/12:00/15:30/23:30 UTC）自動更新されます。最新データの反映には最大数時間かかる場合があります。ページ右上の「Last Updated」時刻を確認してください。',
  },
  {
  ...
  },
  {
    ...
    a: '最大3テーマ、1テーマあたり最大10銘柄まで作成できます。GoogleLoginするとデバイス間でデータが同期されます。未Login時はブラウザのLocalStorageに保存されるため、ブラウザのデータを削除すると失われます。',
  },
  {
  ...
  },
  {
    ...
    a: 'テーマのReturnはそのテーマに属する構成銘柄のReturnの単純Avg値です。個別銘柄は終値ベースで計算しています。',
  },
  {
    q: 'スマホで表が見づらいのですが？',
