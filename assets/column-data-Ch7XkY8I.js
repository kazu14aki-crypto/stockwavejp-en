const e=[{id:"murata-seisakusho-analysis",category:"Stock Analysis",tag:"Electronic Components",title:"Murata Manufacturing (6981): The Electronic Components Giant That Crossed ¥14T Market Cap",date:"2026/05/29",summary:"Murata Manufacturing hit a record ¥14T market cap in May 2026, surpassing Nintendo to become Kyoto's No.1 company. We analyze the business model, competitive advantages, AI/EV growth drivers, and key risks.",body:`
...
`},{id:"mlcc-murata-analysis",category:"Theme",tag:"MLCC/Electronic Components",theme:"MLCC・電子部品",themes:["MLCC・電子部品"],title:"MLCC Industry Analysis: The Most Critical Component for AI & EV Transformation",date:"2026/05/29",summary:"One AI server uses 10–20x more MLCCs than a smartphone. We analyze the structural shift in MLCC demand, Japan's dominant position, and how to invest in this theme.",body:`
## What is an MLCC?
...
> **Disclaimer**: This column is for informational purposes only and does not constitute investment advice.
`},{id:"theme-investing-basics",category:"Theme",tag:"Basics",title:"What is Theme Investing? How It Differs from Individual Stocks and Index Funds",date:"2026/03/14",summary:"Theme investing groups stocks by structural trends — AI, defense, EVs, inbound tourism — and tracks their collective momentum. This article explains how to use StockWaveJP's data for theme-based analysis.",body:`
...
> **Disclaimer**: This column is for informational purposes only and does not constitute investment advice.
`},{id:"semiconductor-theme",category:"Theme",tag:"Semiconductor",title:"Semiconductor Theme: AI Demand, Key Stocks, and Japan's Role in the Global Supply Chain",date:"2026/04/01",summary:"Japan's semiconductor equipment manufacturers — Tokyo Electron, Advantest, Lasertec — are at the center of AI-driven chip demand. This article explains the theme structure and investment considerations.",body:`
...
> **Disclaimer**: This column is for informational purposes only and does not constitute investment advice.
`},{id:"defense-theme",category:"Theme",tag:"Defense",title:"Defense & Space Theme: Japan's Defense Spending Surge and Investment Opportunities",date:"2026/04/01",summary:"Japan's defense budget is on track to double by 2027. Mitsubishi Heavy Industries, Kawasaki Heavy Industries, and IHI are the key beneficiaries. We analyze the structural tailwinds and key stocks.",body:`
...
> **Disclaimer**: This column is for informational purposes only and does not constitute investment advice.
`},{id:"ai-cloud-theme",category:"Theme",tag:"AI/Cloud",title:"AI & Cloud Theme: Japan's Generative AI Investment Wave and Key Players",date:"2026/04/01",summary:"SoftBank Group's massive AI investment, Japanese tech companies' LLM development, and the datacenter buildout are driving AI-related themes. We analyze the opportunity and risks.",body:`
...
> **Disclaimer**: This column is for informational purposes only and does not constitute investment advice.
`},{id:"ev-green-theme",category:"Theme",tag:"EV/Green",title:"EV & Green Theme: Japan's Role in the Electric Vehicle Supply Chain",date:"2026/04/01",summary:"Toyota's EV pivot, all-solid-state battery development, and the global EV supply chain create a complex but important investment theme. We analyze Japan's position and key stocks.",body:`
...
> **Disclaimer**: This column is for informational purposes only and does not constitute investment advice.
`},{id:"inbound-theme",category:"Theme",tag:"Inbound Tourism",title:"Inbound Tourism Theme: Record Visitors and Japan's Consumption Boom",date:"2026/04/01",summary:"Japan welcomed over 35M foreign visitors in 2024. Weak yen and pent-up demand are driving spending at hotels, department stores, and theme parks. We analyze the key stocks and outlook.",body:`
...
> **Disclaimer**: This column is for informational purposes only and does not constitute investment advice.
`},{id:"banking-finance-theme",category:"Theme",tag:"Banking/Finance",title:"Banking & Finance Theme: Japan's Rate Hike Cycle and Bank Profitability",date:"2026/04/01",summary:"After 25 years of near-zero rates, the Bank of Japan is raising rates. This structurally improves net interest margins for Japanese megabanks and regional banks. We analyze the opportunity.",body:`
...
> **Disclaimer**: This column is for informational purposes only and does not constitute investment advice.
`},{id:"optical-communication",category:"Theme",tag:"Optical Communication",title:"Optical Communication Theme: AI Datacenter Bandwidth Demand and Japanese Leaders",date:"2026/04/01",summary:"AI datacenters require massive bandwidth between servers. Japanese optical fiber and component manufacturers — Fujikura, Sumitomo Electric — are benefiting from this structural shift.",body:`
