const H=[{id:"theme-investing-basics",themes:["Theme List"],keywords:["theme stocks","investing","basics","beginner"],category:"Basics",icon:"📘",title:"テーマ株投資とは？個別株・インデックスとの違いをわかりやすく解説",date:"2026/03/20",summary:"「半導体関連株が急騰」「AI銘柄に資金集中」といったニュースを聞いたことがあるでしょう。テーマ株投資とは何か、メリット・リスクをゼロから解説します。",body:`
H2: テーマ株投資とは何か
...
`},{id:"defense-theme",themes:["防衛・航空","宇宙・衛星"],keywords:["defense","Space","防衛費","地政学"],category:"防衛・航空",icon:"🛡️",title:"防衛・宇宙テーマ：地政学リスクと防衛費拡大が生む構造的な追い風",date:"2026/03/14",summary:"日本の防衛費はGDP比2%への増額方針が決定し、2027年度に向けて大幅な拡大が続きます。防衛・宇宙テーマの構造と主要企業の関係を解説します。",body:`
H2: 防衛テーマが注目される背景
...
`},{id:"inbound-theme",themes:["inbound tourism","観光・ホテル・レジャー"],keywords:["inbound tourism","訪日","観光","円安","消費"],category:"inbound tourism",icon:"✈️",title:"インバウンドテーマ：訪日外国人3,000万人超が生む消費拡大と恩恵企業",date:"2026/03/12",summary:"2025年の訪日外客数は3,000万人を超え、過去最高水準が続いています。インバウンド消費の拡大が直接・間接に恩恵をもたらす業種と主要銘柄を解説します。",body:`
H2: インバウンドテーマとは
...
`},{id:"market-cycle",themes:[],keywords:["市場サイクル","資金ローテーション","theme investing"],category:"分析手法",icon:"🔄",title:"市場サイクルとテーマ投資：資金ローテーションを読む技術",date:"2026/03/06",summary:"株式市場では資金は常にどこかへ動いています。市場サイクルに応じてテーマ間で資金がローテーションする仕組みと、それを活用した投資アプローチを解説します。",body:`
H2: 市場サイクルとテーマ投資
...
`},{id:"japan-theme-investing-guide",themes:[],keywords:["theme investing","始め方","口座","銘柄選び"],category:"Basics",icon:"🗾",title:"日本株テーマ投資の始め方（完全ガイド）：口座開設から銘柄選びまで",date:"2026/03/25",summary:"日本株のテーマ投資に興味はあるけど何から始めればいいかわからない、という方のために、口座開設から情報収集・銘柄の選び方まで完全ガイドとしてまとめました。",body:`
H2: 日本株テーマ投資とは何か
...
`},{id:"defense-space-theme",themes:["防衛・航空","宇宙・衛星"],keywords:["defense","Space","防衛費","国防","ミサイル"],category:"防衛・航空",icon:"🛡️",title:"防衛・宇宙テーマ徹底解説：国防費拡大と宇宙開発が生む長期投資機会と主要銘柄の全体像",date:"2026/03/23",summary:"日本の防衛費は2027年度にGDP比2%への増額が決定し、宇宙安全保障も国家戦略として位置づけられました。防衛・宇宙テーマの構造・主要銘柄・リスクを詳しく解説します。",body:`
...
`},{id:"momentum-investing",themes:[],keywords:["momentum","投資タイミング","加速","失速","転換"],category:"分析手法",icon:"📡",title:"騰落モメンタムを使った投資タイミングの考え方：加速・失速・転換シグナルの読み方",date:"2026/03/21",summary:"「騰落モメンタム」は単なる騰落率だけでなく、トレンドの勢いが増しているか衰えているかを示す指標です。加速・失速・転換の3つの状態を活用した投資タイミングの考え方を解説します。",body:`
H2: モメンタムとは何か
...
`},{id:"nisa-popular-stocks",themes:["Banking & Finance","高配当"],keywords:["NISA","人気銘柄","dividend","長期投資"],category:"NISA",icon:"💰",date:"2026/03/24",title:"NISA人気銘柄の傾向分析：なぜ同じ銘柄に資金が集中するのか、その特徴と投資の考え方",summary:"2024年からの新NISA開始で個人投資家の裾野が急拡大しました。NISA口座で人気の銘柄の共通点と、その動向がテーマ投資にどう影響するかを解説します。",body:`
H2: NISA人気銘柄とは何か
...
`},{id:"optical-communication",themes:["Optical Communications","IOWN","通信"],keywords:["Optical Communications","光ファイバー","データセンター","AI","フォトニクス"],category:"Optical Communications",icon:"💡",date:"2026/03/23",title:"光通信テーマ：AI・データセンター需要急増が生む光ファイバー・光部品市場の構造的拡大",summary:"生成AIの普及でデータ通信量が爆発的に増加しています。光ファイバー・光トランシーバー・光半導体など光通信インフラの需要急増と日本企業の強みを解説します。",body:`
H2: 光通信テーマとは
...
`},{id:"renewable-energy-theme",category:"Renewable Energy",icon:"🌱",title:"再生可能エネルギーテーマ徹底解説：脱炭素政策が生む長期成長と主要銘柄・投資機会",date:"2026/04/04",themes:["Renewable Energy","太陽光発電","脱炭素・ESG","蓄電池"],keywords:["Renewable Energy","太陽光","風力","脱炭素","洋上風力","FIT","GX","ESG","電力"],summary:"政府のGX（グリーントランスフォーメーション）政策と2050年カーボンニュートラル目標を背景に、再生可能エネルギーテーマは長期的な成長が見込まれます。太陽光・洋上風力・水素など分野ごとの動向と国内主要銘柄の関係性を詳しく解説します。",body:`
H2: 再生可能エネルギーテーマとは
...
`},{id:"game-entertainment-theme",category:"Game & Entertainment",icon:"🎮",title:"ゲーム・エンタメテーマ徹底解説：経緯・現状・上昇下落因子と主要銘柄",date:"2026/04/04",themes:["Game & Entertainment"],keywords:["ゲーム","エンタメ","任天堂","コナミ","eスポーツ"],summary:"日本のゲーム・エンタメ産業は世界的なコンテンツ競争力を持ちます。スマホゲームの成長、IP活用、eスポーツへの展開と主要銘柄の動向を解説します。",body:`
H2: ゲーム・エンタメテーマとは
...
`},{id:"banking-finance-theme",category:"Banking & Finance",icon:"🏦",title:"銀行・金融テーマ徹底解説：経緯・現状・上昇下落因子と主要銘柄",date:"2026/04/04",themes:["Banking & Finance","地方銀行","フィンテック"],keywords:["銀行","金融","三菱UFJ","みずほ","金利","利上げ","NIM"],summary:"日銀の金利正常化政策を背景に、銀行・金融テーマは長年の低金利環境から脱却しつつあります。利鞘拡大の恩恵とメガバンクの動向を解説します。",body:`
H2: 銀行・金融テーマとは何か
...
`},{id:"regional-bank-theme",category:"地方銀行",icon:"🏢",title:"地方銀行テーマ徹底解説：経緯・現状・上昇下落因子と主要銘柄",date:"2026/04/04",themes:["地方銀行","Banking & Finance"],keywords:["地方銀行","地銀","金利","再編","人口減少"],summary:"日銀の利上げ政策は地方銀行にも追い風となっています。人口減少・地域経済縮小という構造問題を抱える地銀の現状と再編の動向を解説します。",body:`
H2: 地方銀行テーマとは何か
...
`},{id:"real-estate-theme",category:"不動産",icon:"🏗️",title:"不動産テーマ徹底解説：経緯・現状・上昇下落因子と主要銘柄",date:"2026/04/04",themes:["不動産","建設・インフラ","国土強靭化計画"],keywords:["不動産","REIT","三井不動産","地価上昇","inbound tourism","金利"],summary:"都市部の地価上昇・インバウンド需要・オフィス回復を背景に不動産テーマが注目されています。金利上昇リスクとのバランスや主要ディベロッパーの動向を解説します。",body:`
H2: 不動産テーマとは
...
`},{id:"retail-ec-theme",category:"小売・EC",icon:"🛒",title:"小売・ECテーマ徹底解説：経緯・現状・上昇下落因子と主要銘柄",date:"2026/04/04",themes:["小売・EC","リユース・中古品","inbound tourism"],keywords:["小売","EC","楽天","ZHD","消費","DX","キャッシュレス"],summary:"EC市場の拡大と実店舗のデジタル化が加速しています。楽天・ZHDのEC戦略、コンビニ・ドラッグストアの展開、消費者行動の変化と主要企業を解説します。",body:`
H2: 小売・ECテーマとは
...
`},{id:"telecom-theme",category:"通信",icon:"📡",title:"通信テーマ徹底解説：経緯・現状・上昇下落因子と主要銘柄",date:"2026/04/04",themes:["通信","Optical Communications","IOWN"],keywords:["通信","NTT","KDDI","ソフトバンク","5G","データセンター"],summary:"5G展開・光ファイバー普及・データセンター需要急増が通信セクターを下支えします。高配当・安定収益のディフェンシブ特性と成長投資のバランスを解説します。",body:`
H2: 通信テーマとは
...
`},{id:"fintech-theme",category:"フィンテック",icon:"💳",title:"フィンテックテーマ徹底解説：経緯・現状・上昇下落因子と主要銘柄",date:"2026/04/04",themes:["フィンテック","仮想通貨","ネット銀行","Banking & Finance"],keywords:["フィンテック","キャッシュレス","PayPay","マネーフォワード","freee","BNPL"],summary:"キャッシュレス化の普及・家計管理アプリの成長・中小企業向けSaaSの拡大でフィンテックテーマが成長しています。日本のフィンテック市場の構造と主要プレイヤーを解説します。",body:`
H2: フィンテックテーマとは
...
`},{id:"tourism-hotel-theme",category:"観光・ホテル・レジャー",icon:"🏨",title:"観光・ホテル・レジャーテーマ徹底解説：経緯・現状・上昇下落因子と主要銘柄",date:"2026/04/04",themes:["観光・ホテル・レジャー","inbound tourism"],keywords:["観光","ホテル","レジャー","inbound tourism","IR","テーマパーク"],summary:"訪日外国人過去最高と観光消費の拡大を背景に、観光・ホテル・レジャーテーマが急成長しています。IR開業期待も加わる関連銘柄の動向を解説します。",body:`
H2: 観光・ホテル・レジャーテーマとは
...
`},{id:"space-satellite-theme",category:"宇宙・衛星",icon:"🚀",title:"宇宙・衛星テーマ徹底解説：経緯・現状・上昇下落因子と主要銘柄",date:"2026/04/04",themes:["宇宙・衛星","防衛・航空","IOWN"],keywords:["Space","衛星","JAXA","Astroscale","衛星データ","小型ロケット","宇宙戦略基金"],summary:"政府の宇宙戦略基金1兆円超・民間宇宙ビジネスの成長・衛星データ活用が宇宙・衛星テーマを牽引しています。日本の宇宙産業エコシステムを解説します。",body:`
H2: 宇宙・衛星テーマとは
...
`},{id:"value-investing-guide",category:"投資手法",icon:"💎",title:"バリュー投資の基礎：割安株の見つけ方と長期投資の実践",date:"2026/04/05",themes:["Banking & Finance","保険","バフェット銘柄"],keywords:["バリュー投資","PBR","PER","value stocks","長期投資","ウォーレンバフェット","ROE"],summary:"PERやPBRなどの指標を使って「割安な株」を見つけるバリュー投資の基本を解説します。バフェットが実践する長期保有の哲学から、日本株での活用法まで初心者にもわかりやすく説明します。",body:`
H2: バリュー投資とは何か
...
`},{id:"growth-investing-guide",category:"投資手法",icon:"🚀",title:"グロース投資の基礎：高成長企業の見つけ方と売買タイミング",date:"2026/04/05",themes:["生成AI","半導体製造装置","SaaS"],keywords:["グロース投資","growth stocks","PEGレシオ","売上成長率","EPS成長","GARP"],summary:"高い成長率が期待される企業（グロース株）に投資するグロース投資の基本を解説します。成長企業の見分け方、適切な買いタイミング、リスク管理まで詳しく説明します。",body:`
H2: グロース投資とは何か
...
`},{id:"stock-terms-glossary",category:"用語解説",icon:"📖",title:"株式投資用語解説：初心者が押さえるべき50の基本用語",date:"2026/04/05",themes:[],keywords:["株式用語","投資用語","PER","PBR","ROE","dividend","時価総額","信用取引","空売り"],summary:"株式投資を始めるにあたって知っておくべき基本用語を50個厳選して解説します。PER・PBR・配当利回りなどの評価指標から、信用取引・空売りまでわかりやすく説明します。",body:`
...
`},{id:"dividend-investing-guide",category:"投資手法",icon:"💰",title:"高配当株投資の基礎：配当利回りと連続増配銘柄の選び方",date:"2026/04/05",themes:["Banking & Finance","電力会社","保険"],keywords:["配当投資","高配当株","配当利回り","連続増配","配当性向","NISA","インカムゲイン"],summary:"株式投資で安定した収入（インカムゲイン）を得る「高配当株投資」の基本を解説します。配当利回りの見方、連続増配銘柄の選び方、NISAとの組み合わせまで詳しく説明します。",body:`
H2: 高配当株投資とは何か
...
`},{id:"toyota-analysis",category:"個別銘柄",icon:"🚗",title:"トヨタ自動車（7203）徹底解説：EV・HV戦略と2026年の投資ポイント",date:"2026/04/05",themes:["EV・電気自動車","自動運転","全固体電池"],keywords:["トヨタ","7203","自動車","EV","ハイブリッド","全固体電池","dividend"],summary:"日本株時価総額1位のトヨタ自動車を徹底解説。ハイブリッド車の世界的強みとEV戦略の現状、全固体電池の開発動向、配当・株主還元の状況まで個人投資家向けにわかりやすく解説します。",body:`
H2: トヨタ自動車とはどんな会社か
...
`},{id:"sony-analysis",category:"個別銘柄",icon:"🎮",title:"ソニーグループ（6758）徹底解説：ゲーム・音楽・映画・センサーの総合エンタメ企業",date:"2026/04/05",themes:["Game & Entertainment","AI半導体","フィジカルAI"],keywords:["ソニー","6758","PS5","クランチロール","CMOS","映画","音楽","株価"],summary:"ソニーグループはゲーム・音楽・映画・金融・半導体センサーという多様な事業を持つ複合企業。各事業の詳細と投資ポイント、ソニーらしい「安定×成長」の魅力を解説します。",body:`
H2: ソニーグループとはどんな会社か
...
ソニーグループは「ゲーム×音楽×映画×アニメ×センサー」という唯一無二のポートフォリオを持つ企業です。各事業がデジタル化・グローバル化の波に乗って成長しており、日本のエンタメ産業のグローバル競争力を体現しています。長期的な視点で保有に値する優良企業として評価されます。
    `},{id:"mitsubishi-ufj-analysis",category:"個別銘柄",icon:"🏦",title:"三菱UFJフィナンシャル・グループ（8306）徹底解説：金利上昇時代の最注目メガバンク",date:"2026/04/05",themes:["Banking & Finance","フィンテック"],keywords:["三菱UFJ","MUFG","8306","メガバンク","dividend","金利","利上げ","自社株買い"],summary:"日本最大のメガバンク・三菱UFJフィナンシャル・グループを徹底解説。日銀の金利正常化で恩恵を受ける仕組み・海外事業の現状・積極的な株主還元の詳細まで、投資家向けに解説します。",body:`
...
三菱UFJフィナンシャル・グループは「金利正常化の恩恵」「積極的な株主還元」「アジア成長の取り込み」という三つの価値創造要素を持つ日本株の代表的な高配当バリュー株です。NISAでの長期保有と短期のモメンタム投資の双方で活用できる銘柄として、多くの個人投資家の注目を集めています。
    `},{id:"nintendo-analysis",category:"個別銘柄",icon:"🎮",title:"任天堂（7974）徹底解説：Nintendo Switch 2とIP戦略が拓く次の成長ステージ",date:"2026/04/11",themes:["Game & Entertainment"],keywords:["任天堂","7974","Nintendo Switch 2","マリオ","ポケモン","IP","dividend","株価"],summary:"日本が世界に誇るゲーム・エンタメ企業・任天堂を徹底解説。Nintendo Switch 2の発売、マリオ映画に代表されるIPのマルチメディア展開、盤石の財務基盤と株主還元まで、投資家視点で詳しく解説します。",body:`
H2: 任天堂とはどんな会社か
...
`},{id:"fujikura-analysis",category:"個別銘柄",icon:"🔌",title:"フジクラ（5803）徹底解説：光ファイバー・AI電力ケーブルで急成長する素材企業",date:"2026/04/11",themes:["Optical Communications","IOWN","AIデータセンター"],keywords:["フジクラ","5803","光ファイバー","電力ケーブル","データセンター","AI","海底ケーブル"],summary:"フジクラは光ファイバー・電力ケーブル・自動車用ワイヤーハーネスを手掛ける総合ケーブルメーカー。AI・データセンター需要の急増で光ファイバーと電力ケーブルの両輪が急成長。株価は2024年に年初比3倍超を記録した注目銘柄を徹底解説します。",body:`
H2: フジクラとはどんな会社か
...
`},{id:"softbank-analysis",category:"個別銘柄",icon:"📱",title:"ソフトバンク（9434）徹底解説：通信×PayPay×AI投資の総合デジタル企業",date:"2026/04/11",themes:["通信","生成AI","フィンテック"],keywords:["ソフトバンク","9434","PayPay","通信","5G","LINE","dividend","AI"],summary:"ソフトバンク（9434）は国内第3位の通信キャリアとしての安定収益に加え、PayPay・LINE・LINEヤフーというデジタルプラットフォームを傘下に持つ総合デジタル企業。高配当・AI投資・5G展開を軸とした投資ポイントを徹底解説します。",body:`
...
`},{id:"ajinomoto-analysis",category:"個別銘柄",icon:"🍜",title:"味の素（2802）徹底解説：うま味・アミノ酸の世界企業が示す海外展開と高利益率の秘密",date:"2026/04/11",themes:["食品・飲料","農業・フードテック"],keywords:["味の素","2802","うま味","アミノ酸","グローバル","ASEAN","冷凍食品","dividend"],summary:"味の素（2802）はうま味調味料「味の素」で世界に知られる食品企業。アミノ酸技術を核にASEANでのリーダー的地位・高い利益率・連続増配という「食品の優等生」を徹底解説します。",body:`
H2: 味の素とはどんな会社か
...
`},{id:"furukawa-analysis",category:"個別銘柄",icon:"⚡",title:"古河電気工業（5801）徹底解説：光ファイバー・電力ケーブル・車載部品の総合電線メーカー",date:"2026/04/11",themes:["Optical Communications","EV・電気自動車","IOWN"],keywords:["古河電工","5801","光ファイバー","電力ケーブル","ワイヤーハーネス","EV","データセンター","銅"],summary:"古河電気工業（5801）は光ファイバー・電力ケーブル・自動車用ワイヤーハーネス・銅製品を手掛ける総合電線メーカー。AIデータセンター向け光ファイバー需要急増と洋上風力向け電力ケーブルという二大成長テーマを背景に株価が上昇。競合のフジクラ・住友電工とともに光通信テーマの中核銘柄を徹底解説します。",body:`
H2: 古河電気工業とはどんな会社か
...
`},{id:"nittobo-analysis",category:"個別銘柄",icon:"🧵",title:"日東紡績（3110）徹底解説：ガラス繊維世界4位・防音材・住宅建材で独自ポジションを築く素材メーカー",date:"2026/04/11",themes:["Optical Communications","建築資材"],keywords:["日東紡績","3110","ガラス繊維","防音材","グラスウール","建材","医薬","情報通信"],summary:"日東紡績（3110）はガラス繊維（グラスウール）を中核とした素材メーカーで、防音・断熱建材・ガラスクロス・情報通信部品・医薬用途まで多角展開。国内断熱材市場での強固なポジションと、世界的なガラス繊維需要に支えられた成長ストーリーを徹底解説します。",body:`
H2: 日東紡績とはどんな会社か
...
`},{id:"inpex-analysis",category:"個別銘柄",icon:"🛢️",title:"INPEX（1605）徹底解説：日本最大の石油・天然ガス開発会社の資源戦略と投資ポイント",date:"2026/04/11",themes:["石油","LNG","資源（水素・ヘリウム・水）"],keywords:["INPEX","1605","石油","LNG","天然ガス","オーストラリア","イクシス","資源","dividend"],summary:"INPEX（1605）は日本最大の石油・天然ガス開発会社。オーストラリア・イクシスLNGを中核に世界20カ国以上で資源開発事業を展開。資源価格に連動する収益構造・高配当・エネルギー安全保障という観点で注目される企業を徹底解説します。",body:`
H2: INPEXとはどんな会社か
...
`},{id:"sogo-shosha-analysis",category:"個別銘柄",icon:"🏢",title:"総合商社5社完全解説：三菱商事・三井物産・伊藤忠・住友商事・丸紅の投資比較",date:"2026/04/11",themes:["バフェット銘柄","レアアース・資源","LNG"],keywords:["総合商社","三菱商事","三井物産","伊藤忠","住友商事","丸紅","バフェット","dividend","資源"],summary:"日本株の「バフェット銘柄」として世界的に注目される総合商社5社（三菱商事・三井物産・伊藤忠商事・住友商事・丸紅）を徹底比較解説。各社の強み・事業ポートフォリオ・配当・PBRの違いと投資ポイントを詳しく解説します。",body:`
